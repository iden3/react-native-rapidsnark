...
export async function groth16Prove(zkey, witness, {
  ...
  return Rapidsnark.groth16Prove(zkey, witness, proof_buffer_size, public_buffer_size, error_buffer_size);
}
export async function groth16ProveWithZKeyFilePath(zkeyPath, witness, {
  proofBufferSize,
  publicBufferSize,
  errorBufferSize
} = {
  ...
  return Rapidsnark.groth16ProveWithZKeyFilePath(zkeyPath, witness, proof_buffer_size, public_buffer_size, error_buffer_size);
}
